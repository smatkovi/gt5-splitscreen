...
insert(loadutil, 'log4p("LU: load_sequence start");',
       ...
       'var m = mp4p[k4p]; '
       'log4p("MEM " + mn4p[k4p] '
       '+ " nb_vehicle=" + m.nb_vehicle.toString() '
       '+ " set_size=" + m.set_size.toString() '
       '+ " car_size=" + m.car_size.toString() '
       '+ " car_option_size=" + m.car_option_size.toString() '
       '+ " driver_size=" + m.driver_size.toString() '
       '+ " replay_size=" + m.replay_size.toString() '
       '+ " sound_size=" + m.sound_size.toString()); } }')
