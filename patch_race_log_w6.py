...
# w6: ORG.window_max follows the real player count (RaceOperator.window_max), clamped to MOD_WINDOW_MAX.
...
insert(loadutil, 'log4p("LU: load_sequence start");',
       ...
       'ORG.window_max = (RaceOperator.window_max > %d) ? %d : RaceOperator.window_max; '
       'log4p("LU: window_max jetzt ORG=" + ORG.window_max.toString());' % (MOD_WINDOW_MAX, MOD_WINDOW_MAX))
